...
Nowadays i prefer GatsbyJS.

In terms of the requirements for the job, i would say that the only thing i cannot deliver right now is knowledge in Laravel.
...
You can find the repo via the github icon in the top-right corner. You can also find a storybookJS there.
